...
class maxdegreeCombine(object):
    ...
    def __combine(self):
        ...
        f = open('test/{}_{}_maxdegreeadd.txt'.format(fname, master.GRAPH_SETTINGS['edges_sum']), 'w')
        ...
        for i in range(0, self.__edges_sum):
            edgeadd = self.__maxdegree_add_edge(vertex_list0, vertex_list1)
            #print(edgeadd)
    ...
    def __maxdegree_add_edge(self, vertex_list0, vertex_list1):
        max = 0
        edge = (0, 0)
        v0 = (0, 0)
        v1 = (0, 0)
